...
//     echo "user_idは" . htmlspecialchars($_POST['user_id'], ENT_QUOTES, 'UTF-8') . "です。<br>";
//     echo "passwordは" . htmlspecialchars($_POST['password'], ENT_QUOTES, 'UTF-8') . "です。<br>";
// }
var_dump($_POST);
?>
...
<body>
  <form action="sample_post.php" method="post">
    ...
    <input type="radio" name="yes_no" value="no">いいえ
    <select name="pref">
